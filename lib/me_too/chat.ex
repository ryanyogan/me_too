defmodule MeToo.Chat do
  ...
  @doc """
  Creates a conversation, and dispatch the conversation to PHX
  Live View's that are listening.
  ...
  alias MeToo.Chat.MessageReaction
